    ...
    <div class="col-md-12 justify-content-center">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6">
             {!! Form::model($data, ['route' => ['dishes.update', $data->dishes_id], 'method'=>'PATCH','enctype'=>'multipart/form-data']) !!}

                @csrf
                    <div class="form-group">
                        <strong>Dish Name:</strong>

                        {!! Form::text('dishes_name', null, array('placeholder' => 'Dish name','value'=>'{{ $data->dishes_name }}','class' => 'form-control mt-2')) !!}
                    ...
                    <div class="form-group mt-2">
                        ...
                        @endif
                        <br>
                            <input type="hidden" value="{{ $data->dishes_image }}" name="current_image" >
                            <input class="form-control mt-2" type="file"  name="dishes_image">
                    ...
                    <div class="form-group mt-2">
                        <strong>Dish Description:</strong>
                            ...
                            <textarea class="form-control mt-2" rows="4" name="dishes_description">
                        ...
                        <strong>Category</strong>
                           ...
                           <select class="form-control mt-2" name="dishes_category">
                            ...
                            @foreach ($categories as $cat )
                               <option value="{{ $cat->id }}" {{ $data->dishes_category == $cat->id ? "selected" : "" }}>{{ $cat->categories_name }}</option>
                            @endforeach
                           </select>
                    </div>
                    ...
                    <div class="form-group mt-2">
                        <strong>Sub Category :</strong>
                           ...
                           <select class="form-control mt-2" name="dishes_subcategory">
                            ...
                            <option value="{{ $subcat->id }}" {{ $data->dishes_subcategory == $subcat->id ? "selected" : "" }}>{{ $subcat->subcategory_name }}</option>
                        ...
                        <strong> Food Type :</strong>
                           ...
                           <select class="form-control mt-2" name="dishes_food_type">
                            <option value="">Select </option>
                               ...
                               <option value="{{ $foodtype->id }}" {{ $data->dishes_food_type == $foodtype->id ? "selected" : "" }}>{{ $foodtype->food_types_name }} </option>
