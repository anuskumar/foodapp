                                ...
                                <div class="row">
                                    ...
                                    <div class="alert alert-light col-3" role="alert">
                                        ...
                                        {{ Str::ucfirst($value->name) }}
                                                ...
                                                <td>
                                        <input name="permission[]" value="{{ $value->id }}" type="checkbox" id="switch{{$value->id }}" @php if(in_array($value->id, $rolePermissions)) {echo "checked";} @endphp  data-switch="success"/>
